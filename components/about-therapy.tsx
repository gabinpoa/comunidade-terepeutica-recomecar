  ...
  const stages = [
    {
      ...
      description: "Entrevista clínica para entender as necessidades individuais.",
    },
    {
      number: "2",
    ...
    <section className="py-12 md:py-16 px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 rounded-lg overflow-hidden">
          <img src="/women-hugging-support-group-therapy.jpg" alt="Terapia em grupo" className="w-full h-64 md:h-80 object-cover" />
        </div>

        <p className="text-slate-700 mb-8 leading-relaxed">
          Aqui, a recuperação acontece em etapas, com apoio humano e atividades que promovem bem-estar físico e
          emocional.
        </p>

        <h3 className="text-xl md:text-2xl font-bold mb-6 text-slate-900">Etapas:</h3>
