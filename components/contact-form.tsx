...
export function ContactForm() {
  ...
  return (
    <section className="py-12 md:py-16 px-6 bg-amber-50">
      <div className="max-w-md mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold mb-2 text-slate-900">Fale Conosco</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-slate-800 hover:bg-slate-900 text-white" size="lg">
            Pedir Contato
          </Button>
        </form>
